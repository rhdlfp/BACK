...
public class QnaPagingUtil {
	 ...
	 */
	public QnaPagingUtil(int currentPageNum) {
	 ...
	 */
	public QnaPagingUtil(int currentPageNum, int objectCountPerPage, int pageNumCountPerPage) {
		this.currentPageNum = (0 < currentPageNum) ? currentPageNum : 1 ;
	...
	public String toString() {
		return "QnaPagingUtil [currentPageNum=" + currentPageNum + ", objectCountTotal=" + objectCountTotal
